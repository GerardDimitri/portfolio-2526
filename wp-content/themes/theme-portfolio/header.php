...
<body <?php body_class(); ?> itemscope itemtype="https://schema.org/Person">
<header class="header" role="banner">
    ...
    <nav class="header__nav" role="navigation" aria-label="Navigation principale">
        ...
        <label class="header__burger" for="menu-toggle" id="burger">
            ...
            <svg focusable="false" aria-hidden="true" width="48" height="32" viewBox="0 0 48 32"
                 xmlns="http://www.w3.org/2000/svg">
                <path class="line-top"
                      d="M24.2648 7.57568L13.4553 5.97009C8.18626 5.20121 6.01532 3.86699 0.022614 2.96243C0.022614 2.93982 18.7696 0 18.9279 0C27.9735 1.26638 36.0467 1.42468 42.469 2.2614L43.6902 2.41969L44.8209 2.57799L44.0294 4.83939C43.6223 4.83939 24.7397 7.64352 24.2648 7.57568Z"/>
                <path class="line-mid"
                      d="M1.24377 14.4277L2.28401 14.2694L3.50516 14.1111C9.99537 13.297 18.0459 13.1387 27.2724 11.8497C27.4081 11.8497 47.3989 14.7895 47.3084 14.7895C41.2479 15.6941 38.1271 17.0509 32.7903 17.7972L21.8677 19.4028C21.3928 19.4028 2.32924 16.6891 1.89957 16.7569L1.24377 14.4277Z"/>
                <path class="line-bot"
                      d="M42.469 26.7523L43.6902 26.9106L44.8209 27.0689L44.0294 29.3303C43.5997 29.3303 24.7171 32.0666 24.2422 31.9988L13.4327 30.3932C8.16364 29.6243 6.01532 28.2901 0 27.3855C0 27.3855 18.747 24.4005 18.9053 24.4231C28.0639 25.7573 36.0467 25.9382 42.469 26.7523Z"/>
            </svg>
        </label>
                        ...
                        <li class="header__item header__item--lang">
                            <a class="header__link" href="<?= $link['url'] ?>"
                               title="Changer la langue en <?= $lang ?>">
                                <span class="nav__label"><?= strtoupper($lang) ?></span>
                            </a>
                        </li>
                    <?php endforeach; ?>
                <?php endif; ?>
